...
@Controller
@RequestMapping(value={"/goip/goIPDevNew"})
@CommonTabCtrlInit(resource = "goip_goIPDevNew", viewName = "/page/goip/goIPDevNew")
public class GoIPDevNewCtrl extends FrameBaseCtrl<TbGoIPDev> {
