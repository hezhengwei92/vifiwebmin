...
@Controller
@RequestMapping(value = {"/rate/data-rate", "/vsw/data-rate"})
@CommonTabCtrlInit(viewName = "/page/rate/rate", resource = "vpx_rateNewVer")
public class DataRateCtrl extends FrameBaseCtrl<TbRate> {
