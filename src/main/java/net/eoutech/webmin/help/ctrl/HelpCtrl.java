package net.eoutech.webmin.help.ctrl;
...
@CommonTabCtrlInit( viewName="/page/help/help", resource = "new_help" )
public class HelpCtrl extends FrameBaseCtrl<TbHelp> {
    ...
    @Autowired
    public void setCfrmBaseService(HelpService commonTabService){
       this.frameBaseService = helpService = commonTabService;
    }
    ...
    public RestObject queryAjax(
        ...
        Page<TbHelp> page = frameBaseService.query(pageNumber, pageSize, queryParam);
